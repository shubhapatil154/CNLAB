...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("flow-control");
...
int main(int argc,char *argv[])
{
	...
	p2p.EnablePcap("flow-control",dev,false);
	...
	for(std::map<FlowId,FlowMonitor::FlowStats>::const_iterator i = stats.begin();i!=stats.end();++i)
	{
		...
		std::cout<<"t.sourceAddress="<<t.sourceAddress<<"t.destinationAddress="<<t.destinationAddress<<"Source port:"<<t.sourcePort<<""<<"Desination port:"<<t.destinationPort<<"\n";
		if((t.sourceAddress=="10.1.1.1" && t.destinationAddress=="10.1.1.2"))
		{
		    ...
		    monitor->SerializeToXmlFile("flow-control.flowmon",true,true);
		    Simulator::Destroy();
		    NS_LOG_INFO("Done.");
}
...
t.sourceAddress=10.1.1.1t.destinationAddress=10.1.1.2Source port:49153Desination port:8000
flow1(10.1.1.1->10.1.1.2
Tx Bytes: 16832
Rx Bytes: 16832
Tx packets: 16
Rx Packets: 16
Throughput:0.0149618Mbps
